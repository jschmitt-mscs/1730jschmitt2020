    ...
    public partial class fr : Form
    {
        ...
        private void btnPlus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                byte3TextBox.Text = this.byte3.ToString();
            } catch (Exception)
            {
                byte3TextBox.Text = "error";
            }

            try
            {
                this.sbyte3 = Convert.ToSByte(this.sbyte1 + this.sbyte2);
                sbyte3TextBox.Text = this.sbyte3.ToString();
            }
            catch (Exception)
            {
                sbyte3TextBox.Text = "error";
            }

            try
            {
                this.short3 = Convert.ToInt16(this.short1 + this.short2);
                short3TextBox.Text = this.short3.ToString();
            }
            catch (Exception)
            {
                short3TextBox.Text = "error";
            }
            ...
            {
                int3TextBox.Text = "error";
            }

            try
            {
                this.uint3 = checked(Convert.ToUInt32(this.uint1 + this.uint2));
            ...
            try
            {
                this.long3 = checked(Convert.ToInt64(this.long1 + this.long2));
                long3TextBox.Text = this.long3.ToString();
            }
            catch (Exception)
            {
                long3TextBox.Text = "error";
            }

            try
            {
                this.ulong3 = checked(Convert.ToUInt64(this.ulong1 + this.ulong2));
                ulong3TextBox.Text = this.ulong3.ToString();
            }
            catch (Exception)
            {
                ulong3TextBox.Text = "error";
            }
